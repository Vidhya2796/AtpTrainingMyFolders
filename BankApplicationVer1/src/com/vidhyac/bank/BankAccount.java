...
public abstract class BankAccount {
	...
	//during class loading itself the static var got initialised(default values will be initialised)
	...
	//i can modify/reinitialise member variable's data after the object is created
...
//service methods
	...
	public void deposit(double amount){
		this.accountBalance+=amount;
		System.out.println("accnt bal is "+ getAccountBalance());
	}
